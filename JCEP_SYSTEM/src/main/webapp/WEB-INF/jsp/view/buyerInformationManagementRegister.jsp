...
/****************************************수정start**************************************/
	...
	/*히스토리 추가 */
				$("#histBtn").click(function(){
					...
					var memberId = '${data.memberId}';
					formData.append("memberId",memberId);//아이디
					...
					$.ajax({
						...
						success : function(data) {
							if(data.returnCode == 0 || data.returnCode1 == 0){
								...
								alert("등록이 완료 되었습니다.");
								document.getElementById('buyerHistNm').value="";
								document.getElementById('buyerHistInvt').value="";
								document.getElementById('buyerHistSpecCd').value="";
								document.getElementById('buyerHistDt').value="";
								document.getElementById('buyerHistContent').value="";
								document.getElementById('processCd').value="";
								$("#buyerHistPop").hide();
								buyerHistList();
							}
						},  
							...
							<div class="table-responsive">
										...
										<tr>
											...
											<td>
												<label class="input" style="width:100%">
													...
													<input type="text" id="buyerCapitalAmt" name="buyerCapitalAmt"value="<fmt:formatNumber value="${data.buyerCapitalAmt}" pattern="#,###"/>" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" maxlength="10" style="width:40%">
												</label>
											</td>
										</tr>
									</tbody>
								...
								<div class="col-xs-12">
									...
									<div style="padding-top:5px;padding-bottom:5px;text-align:right;width:99%">
										<a href="#a" id="resultAddBtn" class="btn btn-primary floatR" ><b>추가</b></a>
									</div>
								</div>
								
								<table id="resultTable" class="table table-hover" style="margin-bottom:0px;width:98%;margin-left:1%;margin-top:10px;">
									<colgroup>
										<col width="10%"><col width="15%"><col width="15%"><col width="15%"><col width="15%"><col width="10%"><col width="10%"><col width="10%">
									</colgroup>
									<thead>
										<tr>
											<th>NO</th>
								...
								<div style="padding-top:5px;padding-bottom:5px;text-align:right;width:99%">
									...
									<button type="button" id="saveBtn" class="btn btn-primary">저장<span></span></button>
								</div>
							</div>
						</form>
					</div>
