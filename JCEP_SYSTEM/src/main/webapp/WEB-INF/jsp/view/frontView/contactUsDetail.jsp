			...
			<div class="cont">
				...
				<div class="continner">
					<div class="daylist">
						...
						<div class="morew">
							<a href="#">
								<button type="button" id="createBtn" class="createBtn"><span>등1록</span></button>
							</a>
							<a href="/db/contactUsList.do">
								<button type="button" class="submitbtn btnlist">목12록<span></span></button>
							</a>
						</div>
					</div>
				</div>
					...
					<div class="daylist">
						<div class="dview">
							...
							<tr>
								<th>제목*</th>
								<td>
									<input type="text" style="width: 100%;" id="questionTitle" name="questionTitle" value="${detail.questionTitle} " />
								</td>
								<th>비밀번호*</th>
								<td colspan="2">
									<input type="password" style="width: 100%;" id="questionPw" name="questionPw" value="${detail.questionPw} " />
								</td>
							</tr>
							<tr>
								<th>작성1자*</th>
								<td>
									<input type="text" style="width: 100%;" id="writeNm" name="writeNm" value="${detail.writeNm} " />
								</td>
								<th>등록일</th>
								<td colspan="2">
									<input type="text" style="width: 100%;" id="writeDt" name="writeDt" value="${detail.writeDt}" />
								</td>
							</tr>
							<tr>
								<th>내용</th>
								<td colspan="4">
									<textarea rows="6" style="width:100%; text-align: left;" id="questionCont" name="questionCont">
										<c:out value="${detail.questionCont}" />
									</textarea>
								</td>
							</tr>
							...
							<tr>
								<th>답변 내용</th>
								<td colspan="4">
									<textarea rows="6" style="width:100%; height: 100px;" id="answerCont" name="answerCont">
										<c:out value="${detail.answerCont}" /> 
									</textarea>
								</td>
							</tr>
