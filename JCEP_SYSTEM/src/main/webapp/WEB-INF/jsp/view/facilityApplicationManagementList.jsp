...
<body>
	...
	<div id="main" role="main" class="content">
		...
		<div id="ribbon">
			<!-- breadcrumb -->
			<ol class="breadcrumb">
				<li>Home</li><li>시설 및 자원 관리</li><li><b>시설 신청 관리</b></li>
			</ol>
			<!-- end breadcrumb -->
		</div>
		<!-- END RIBBON -->
		...
		<div id="content">
			<div class="row">
				<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
					<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i><b>시설 신청 관리</b></h1>
				</div>
			</div>
			<!-- widget grid -->
        	...
        	var param = {};
			 ...
			 $.ajax({
					...
					success : function(data) {
	                		...
	                		var fData = data.facilityList;
							var fDataLength = fData.length;
							for(var i=0;i < fDataLength;i++){
								document.insertFrm.facilityNm.options[i] = new Option(fData[i].facilityNm,fData[i].facilityId);
							}	                
