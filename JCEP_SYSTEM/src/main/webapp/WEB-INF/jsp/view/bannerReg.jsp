...
<script type="text/javaScript" language="javascript" defer="defer">
	$(document).ready(function () {
		...
		$("#createBtn").click(function(){
			if(checkValue()){
				 $("#noticeCont").val(CKEDITOR.instances.noticeCont.getData());	
				 $.ajax({
						type : 'post',
							...
							<table class="table table-bordered table-striped" style="margin-bottom:0px;width:98%;margin-left:1%;margin-top:10px;">
								...
								<tbody>
										...
										<tr>
											...
											<td colspan="3">
												<div class="editor">	
													<textarea id="noticeCont"name="noticeCont" rows="6" cols="6" style="width:100%; height:100px;"><c:out value="${detail.noticeCont}"/></textarea>
												</div>
											</td>
										</tr>
