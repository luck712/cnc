...
<script type="text/javaScript" >
	$(document).ready(function () {
      ...
      function fn_egov_link_page(pageNo){
        ...
        document.listForm.action = "<c:url value='/business/businessInfraEnterpriseList.do'/>";
		...
		<div id="content">
			...
			<div class="table-responsive">
				<ul class="tab01_4 clearfix">
					<li style="width:50%"><a href="/db/business/businessInfraResourFaciUseResultList.do">장비,시설 활용실적</a></li>
					<li class="on" style="width:50%"><a href="/db/business/businessInfraEnterpriseList.do">기업입주현황</a></li>					
				</ul>
			</div>			
			<!-- widget grid -->
