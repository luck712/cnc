...
<script type="text/javaScript" >
	$(document).ready(function () {
      ...
      function fn_egov_link_page(pageNo){
      	...
      	document.listForm.action = "<c:url value='/business/businessSupportBenefitList.do'/>";
		...
		<div id="content">
			...
			<div class="table-responsive">
				<ul class="tab01_4 clearfix">
					<li class="on"><a href="/db/business/businessSupportBenefitList.do">지원사업수혜실적</a></li>
			...
			<div style="padding-bottom:5px;text-align:right;">
				<a href="/db/business/businessSupportBenefitReg.do" class="btn btn-primary" id="insertBtn" ><b>등록</b></a>
			</div>
		</div>
		<!-- END MAIN CONTENT -->
