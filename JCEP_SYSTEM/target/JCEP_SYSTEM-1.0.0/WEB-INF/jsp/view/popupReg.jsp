		...
		<div id="content">
			<div class="row">
				<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
					<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i><b>팝업 등록</b></h1>
				</div>
			</div>
					...
					<form id="insertFrm" name="insertFrm" action="#" method="POST">
						<div class="table-responsive">
							<table class="table table-bordered table-striped" style="margin-bottom:0px;width:98%;margin-left:1%;margin-top:10px;">
								...
								<tbody>
									<tr>
										<th style="text-align:center;background:#eee;vertical-align:middle;">팝업명 * </th>
										<td>
									...
									<tr>
										<th style="text-align:center;background:#eee;vertical-align:middle;">팝업파일 *</th>
										<td>
									...
									<tr>
										<th style="text-align:center;background:#eee;vertical-align:middle;">팝업설명</th>
										<td>
											<label class="input" style="width: 100%;">
