										...
										<c:if test="${paginationInfo.totalRecordCount ne 0 }">
											<c:forEach var="result" items="${resultList}" varStatus="status">
												<tr>
													...
													<td style="vertical-align: middle;"><img src="<c:out value="${result.facilityImg}"/>"  width="177" height="125"/></td>
													<td style="vertical-align: middle;"><c:out value="${result.facilityNm}"/></td>
