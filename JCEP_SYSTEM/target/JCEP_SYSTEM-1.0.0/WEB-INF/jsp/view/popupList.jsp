...
<body>
	...
	<div id="main" role="main" class="content">
		...
		<div id="ribbon">
			<!-- breadcrumb -->
			<ol class="breadcrumb">
				<li>Home</li><li>사이트 관리</li><li><b>팝업 관리</b></li>
			</ol>
			<!-- end breadcrumb -->
		</div>
		<!-- END RIBBON -->
		...
		<div id="content">
			<div class="row">
				<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
					<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i><b>팝업 관리</b></h1>
				</div>
			</div>
			<!-- widget grid -->
			<section id="widget-grid" class="">
									...
									<tbody>
										<tr>
											...
											<td>
												...
												<a href="javascript:goSearch();" class="btn btn-primary" style="margin-left: 500px;"><b>검색</b></a>
											</td>
										</tr>
									</tbody>
								</table>
					...
					<div class="well well-sm">
						<div class="table-responsive">
							<div class="col-xs-12">
								<h6 class="page-title txt-color-blueDark"><b>총 : <fmt:formatNumber value="2" pattern="#,###" /> 건</b></h6>
							</div>
			...
			<div style="padding-bottom:5px;text-align:right;">
				<a href="/db/site/popupReg.do" class="btn btn-primary" id="insertBtn" ><b>등록</b></a>
			</div>
			<!-- end widget grid -->
		</div>
		<!-- END MAIN CONTENT -->
